...
const subCategories = [
  { name: "Seater", href: "#" },
  { name: "Sleeper", href: "#" },
  { name: "Semi Sleeper", href: "#" },
  { name: "Sleeper (AC)", href: "#" },
  { name: "Semi Sleeper (AC)", href: "#" },
];
const filters = [
  {
    id: "color",
            ...
            >
              <div className="ml-auto relative max-w-xs w-full h-full bg-white shadow-xl py-4 pb-12 flex flex-col overflow-y-auto">
                ...
                <form className="mt-4 border-t border-gray-200">
                  ...
                  <ul
                    role="list"
                    className="font-normal text-gray-900 px-2 py-3"
                  >
        ...
        <main className="max-w-12xl mx-auto px-1 sm:px-12 lg:px-12">
          <div className="relative  flex items-baseline justify-between pt-5 pb-3 border-b border-gray-200">
            <div className="max-w-6xl flex">
              ...
              <h4 className="font-bold px-5">Chennai</h4>

              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 font-light"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
          ...
          <section aria-labelledby="products-heading" className="pt-6 pb-24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
              ...
              <form className="hidden lg:block">
                ...
                <ul
                  role="list"
                  className="text-sm font-normal text-gray-900 space-y-4 pb-6 border-b border-gray-200"
                >
                  {subCategories.map((category) => (
                    <li key={category.name}>
